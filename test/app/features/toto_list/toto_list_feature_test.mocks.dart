...
// in saturne_todo_app_djamo/test/app/features/toto_list/toto_list_feature_test.dart.
...
class MockTaskRepository extends _i1.Mock implements _i2.TaskRepository {
  ...
  @override
  _i3.Future<List<_i4.TaskEntity>> getAllTasks() => (super.noSuchMethod(
        Invocation.method(
          #getAllTasks,
          [],
        ),
  ...
  @override
  _i3.Future<_i4.TaskEntity?> getTaskById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getTaskById,
          [id],
        ),
  ...
  @override
  _i3.Future<void> addTask(_i4.TaskEntity? task) => (super.noSuchMethod(
        Invocation.method(
          #addTask,
          [task],
        ),
  ...
  @override
  _i3.Future<void> updateTask(_i4.TaskEntity? task) => (super.noSuchMethod(
        Invocation.method(
          #updateTask,
          [task],
        ),
